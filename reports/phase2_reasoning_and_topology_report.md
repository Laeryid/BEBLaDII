...
## 2. Datasets Used
As sources of "pure logic", we used datasets containing high-quality Chain-of-Thought reasoning:
- **`Magpie-Reasoning-V2`**: ~250k deep CoT examples generated by DeepSeek-R1-Llama-70B.
- **`OpenThoughts-114k`**: 114k high-quality reasoning chains.

The datasets were pre-tokenized using Qwen2.5 and saved in Parquet format to ensure high-speed loading on TPUs without I/O bottlenecks.
