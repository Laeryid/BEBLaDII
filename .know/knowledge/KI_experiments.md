...
## Реестр экспериментов (storage/experiments)
| Директория | Дата | Описание | Результат |
|---|---|---|---|
| `20260413 Phase 1 Awakening weights` | 13.04.26 | Первая удачная дистилляция проекторов Awakening. | Базовые проекторы готовы. |
| `20260414 Phase 1 Reasoning failed start` | 14.04.26 | Попытка старта Reasoning с некорректным LR. | Провал, пересмотр стратегии LR. |
| `20260419 Phase 1 Reasoning 5400 steps` | 19.04.26 | Стабильный прогон Reasoning на 5400 шагов. | Чекпоинт для дальнейшего обучения. |
| `20260506 Phase + Reasoning 50000 steps` | 06.05.26 | Масштабный прогон с новым планировщиком. | Лучшая модель на текущий момент. |
